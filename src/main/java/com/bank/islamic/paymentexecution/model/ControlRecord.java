package com.bank.islamic.paymentexecution.model;
...
/**
 * The BIAN control record for this service domain: "Payment Transaction Procedure".
 *
 ...
 * to its asset type (Payment Transaction). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Payment Transaction Procedure";
